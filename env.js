...
const BUNDLE_ID = 'com.rn-starter'; // ios bundle id
const PACKAGE = 'com.rn_starter'; // android package name
const NAME = 'rn-starter'; // app name
const EXPO_ACCOUNT_OWNER = 'expo'; // expo account owner
